...
public class CourseSearchAdapter extends BaseAdapter<Course, CourseViewHolder> {

    public CourseSearchAdapter(AdapterListener<Course> callback) { this(new ArrayList<Course>(), callback); }

    public CourseSearchAdapter(List<Course> data, AdapterListener<Course> callback) {
        super(data, callback);
    }
